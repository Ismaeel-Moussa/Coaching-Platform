...
import type { ProgressReportOptions, ProgressReportPreviewOptions, SaveFeedbackNoteForm } from '../../types/CoachHub';
...
export const useGetAthleteProgressReport = (id: number, options: ProgressReportPreviewOptions) =>
  useQuery({
