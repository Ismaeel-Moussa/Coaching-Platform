...
public static class SeedExtensions
{
        ...
        RoleManager<Role> roleManager)
    {
        ...
        if (!await context.Foods.AnyAsync())
        {
            ...
            {
                // ── Protein Sources (Raw) ──
                new() { Name = "Chicken Breast (Skinless)", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 165, ProteinPer100g = 31m, CarbsPer100g = 0m, FatPer100g = 3.6m, FiberPer100g = 0m },
                new() { Name = "Chicken Thigh (Skinless)", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 177, ProteinPer100g = 24m, CarbsPer100g = 0m, FatPer100g = 8.2m, FiberPer100g = 0m },
                new() { Name = "Canned Tuna (in Water)", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 116, ProteinPer100g = 25.5m, CarbsPer100g = 0m, FatPer100g = 0.8m, FiberPer100g = 0m },
                new() { Name = "Salmon (Atlantic)", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 208, ProteinPer100g = 20m, CarbsPer100g = 0m, FatPer100g = 13m, FiberPer100g = 0m },
                new() { Name = "Ground Beef (85% Lean)", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 215, ProteinPer100g = 26m, CarbsPer100g = 0m, FatPer100g = 11.8m, FiberPer100g = 0m },
                new() { Name = "Ground Turkey (93% Lean)", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 149, ProteinPer100g = 22m, CarbsPer100g = 0m, FatPer100g = 6.7m, FiberPer100g = 0m },
                new() { Name = "Whole Eggs", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 155, ProteinPer100g = 13m, CarbsPer100g = 1.1m, FatPer100g = 10.6m, FiberPer100g = 0m },
                new() { Name = "Egg Whites", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 52, ProteinPer100g = 10.9m, CarbsPer100g = 0.7m, FatPer100g = 0.2m, FiberPer100g = 0m },
                new() { Name = "Cottage Cheese (Low Fat)", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 84, ProteinPer100g = 11m, CarbsPer100g = 3.4m, FatPer100g = 2.4m, FiberPer100g = 0m },
                new() { Name = "Greek Yogurt (0% Fat)", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 59, ProteinPer100g = 10m, CarbsPer100g = 3.6m, FatPer100g = 0.4m, FiberPer100g = 0m },
                new() { Name = "Tilapia", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 128, ProteinPer100g = 26m, CarbsPer100g = 0m, FatPer100g = 2.7m, FiberPer100g = 0m },
                new() { Name = "Shrimp", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 99, ProteinPer100g = 24m, CarbsPer100g = 0.2m, FatPer100g = 0.3m, FiberPer100g = 0m },
                new() { Name = "Beef Steak (Sirloin)", Category = "Protein", State = FoodState.Raw, CaloriesPer100g = 207, ProteinPer100g = 26m, CarbsPer100g = 0m, FatPer100g = 11m, FiberPer100g = 0m },
                new() { Name = "Whey Protein Powder", Category = "Protein", State = FoodState.Dry, CaloriesPer100g = 375, ProteinPer100g = 74m, CarbsPer100g = 7m, FatPer100g = 5m, FiberPer100g = 0m },

                // ── Protein Sources (Cooked counterparts) ──
                new() { Name = "Chicken Breast (Cooked)", Category = "Protein", State = FoodState.Cooked, CaloriesPer100g = 165, ProteinPer100g = 31m, CarbsPer100g = 0m, FatPer100g = 3.6m, FiberPer100g = 0m },
                new() { Name = "Chicken Thigh (Cooked)", Category = "Protein", State = FoodState.Cooked, CaloriesPer100g = 177, ProteinPer100g = 24m, CarbsPer100g = 0m, FatPer100g = 8.2m, FiberPer100g = 0m },
                new() { Name = "Beef Steak (Cooked)", Category = "Protein", State = FoodState.Cooked, CaloriesPer100g = 207, ProteinPer100g = 26m, CarbsPer100g = 0m, FatPer100g = 11m, FiberPer100g = 0m },
                new() { Name = "Salmon (Cooked)", Category = "Protein", State = FoodState.Cooked, CaloriesPer100g = 208, ProteinPer100g = 20m, CarbsPer100g = 0m, FatPer100g = 13m, FiberPer100g = 0m },

                // ── Carbohydrate Sources ──
                new() { Name = "White Rice (Dry)", Category = "Carbs", State = FoodState.Dry, CaloriesPer100g = 365, ProteinPer100g = 7.1m, CarbsPer100g = 80m, FatPer100g = 0.7m, FiberPer100g = 0.4m },
                new() { Name = "Brown Rice (Dry)", Category = "Carbs", State = FoodState.Dry, CaloriesPer100g = 367, ProteinPer100g = 7.9m, CarbsPer100g = 76m, FatPer100g = 2.9m, FiberPer100g = 3.5m },
                new() { Name = "Rolled Oats (Dry)", Category = "Carbs", State = FoodState.Dry, CaloriesPer100g = 389, ProteinPer100g = 17m, CarbsPer100g = 66m, FatPer100g = 7m, FiberPer100g = 10.6m },
                new() { Name = "Sweet Potato", Category = "Carbs", State = FoodState.Raw, CaloriesPer100g = 86, ProteinPer100g = 1.6m, CarbsPer100g = 20m, FatPer100g = 0.1m, FiberPer100g = 3m },
                new() { Name = "Regular Potato", Category = "Carbs", State = FoodState.Raw, CaloriesPer100g = 77, ProteinPer100g = 2m, CarbsPer100g = 17m, FatPer100g = 0.1m, FiberPer100g = 2.2m },
                new() { Name = "Banana", Category = "Carbs", State = FoodState.Raw, CaloriesPer100g = 89, ProteinPer100g = 1.1m, CarbsPer100g = 23m, FatPer100g = 0.3m, FiberPer100g = 2.6m },
                new() { Name = "Apple", Category = "Carbs", State = FoodState.Raw, CaloriesPer100g = 52, ProteinPer100g = 0.3m, CarbsPer100g = 14m, FatPer100g = 0.2m, FiberPer100g = 2.4m },
                new() { Name = "Pasta (Dry)", Category = "Carbs", State = FoodState.Dry, CaloriesPer100g = 371, ProteinPer100g = 13m, CarbsPer100g = 75m, FatPer100g = 1.5m, FiberPer100g = 3m },
                new() { Name = "Bread (Whole Wheat)", Category = "Carbs", State = FoodState.Raw, CaloriesPer100g = 247, ProteinPer100g = 13m, CarbsPer100g = 41m, FatPer100g = 4.2m, FiberPer100g = 7m },
                new() { Name = "Quinoa (Dry)", Category = "Carbs", State = FoodState.Dry, CaloriesPer100g = 368, ProteinPer100g = 14m, CarbsPer100g = 64m, FatPer100g = 6m, FiberPer100g = 7m },
                new() { Name = "Orange", Category = "Carbs", State = FoodState.Raw, CaloriesPer100g = 47, ProteinPer100g = 0.9m, CarbsPer100g = 12m, FatPer100g = 0.1m, FiberPer100g = 2.4m },
                new() { Name = "Dates (Dried)", Category = "Carbs", State = FoodState.Dry, CaloriesPer100g = 282, ProteinPer100g = 2.5m, CarbsPer100g = 75m, FatPer100g = 0.4m, FiberPer100g = 8m },
                new() { Name = "Rice Cakes", Category = "Carbs", State = FoodState.Dry, CaloriesPer100g = 387, ProteinPer100g = 8m, CarbsPer100g = 82m, FatPer100g = 3m, FiberPer100g = 0.6m },

                // ── Fat Sources ──
                new() { Name = "Almonds", Category = "Fat", State = FoodState.Dry, CaloriesPer100g = 579, ProteinPer100g = 21m, CarbsPer100g = 22m, FatPer100g = 50m, FiberPer100g = 12.5m },
                new() { Name = "Walnuts", Category = "Fat", State = FoodState.Dry, CaloriesPer100g = 654, ProteinPer100g = 15m, CarbsPer100g = 14m, FatPer100g = 65m, FiberPer100g = 6.7m },
                new() { Name = "Avocado", Category = "Fat", State = FoodState.Raw, CaloriesPer100g = 160, ProteinPer100g = 2m, CarbsPer100g = 9m, FatPer100g = 15m, FiberPer100g = 6.7m },
                new() { Name = "Olive Oil", Category = "Fat", State = FoodState.Raw, CaloriesPer100g = 884, ProteinPer100g = 0m, CarbsPer100g = 0m, FatPer100g = 100m, FiberPer100g = 0m },
                new() { Name = "Peanut Butter", Category = "Fat", State = FoodState.Raw, CaloriesPer100g = 588, ProteinPer100g = 25m, CarbsPer100g = 20m, FatPer100g = 50m, FiberPer100g = 6m },
                new() { Name = "Cashews", Category = "Fat", State = FoodState.Dry, CaloriesPer100g = 553, ProteinPer100g = 18m, CarbsPer100g = 30m, FatPer100g = 44m, FiberPer100g = 3.3m },
                new() { Name = "Coconut Oil", Category = "Fat", State = FoodState.Raw, CaloriesPer100g = 862, ProteinPer100g = 0m, CarbsPer100g = 0m, FatPer100g = 100m, FiberPer100g = 0m },
                new() { Name = "Cheddar Cheese", Category = "Fat", State = FoodState.Raw, CaloriesPer100g = 402, ProteinPer100g = 25m, CarbsPer100g = 1.3m, FatPer100g = 33m, FiberPer100g = 0m },

                // ── Vegetables ──
                new() { Name = "Broccoli", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 34, ProteinPer100g = 2.8m, CarbsPer100g = 7m, FatPer100g = 0.4m, FiberPer100g = 2.6m },
                new() { Name = "Spinach", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 23, ProteinPer100g = 2.9m, CarbsPer100g = 3.6m, FatPer100g = 0.4m, FiberPer100g = 2.2m },
                new() { Name = "Kale", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 49, ProteinPer100g = 4.3m, CarbsPer100g = 9m, FatPer100g = 0.9m, FiberPer100g = 3.6m },
                new() { Name = "Cauliflower", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 25, ProteinPer100g = 1.9m, CarbsPer100g = 5m, FatPer100g = 0.3m, FiberPer100g = 2m },
                new() { Name = "Asparagus", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 20, ProteinPer100g = 2.2m, CarbsPer100g = 3.9m, FatPer100g = 0.1m, FiberPer100g = 2.1m },
                new() { Name = "Cucumber", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 15, ProteinPer100g = 0.7m, CarbsPer100g = 3.6m, FatPer100g = 0.1m, FiberPer100g = 0.5m },
                new() { Name = "Bell Pepper", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 31, ProteinPer100g = 1m, CarbsPer100g = 6m, FatPer100g = 0.3m, FiberPer100g = 2.1m },
                new() { Name = "Tomato", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 18, ProteinPer100g = 0.9m, CarbsPer100g = 3.9m, FatPer100g = 0.2m, FiberPer100g = 1.2m },
                new() { Name = "Zucchini", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 17, ProteinPer100g = 1.2m, CarbsPer100g = 3.1m, FatPer100g = 0.3m, FiberPer100g = 1m },
                new() { Name = "Green Beans", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 31, ProteinPer100g = 1.8m, CarbsPer100g = 7m, FatPer100g = 0.1m, FiberPer100g = 2.7m },
                new() { Name = "Mushrooms", Category = "Vegetable", State = FoodState.Raw, CaloriesPer100g = 22, ProteinPer100g = 3.1m, CarbsPer100g = 3.3m, FatPer100g = 0.3m, FiberPer100g = 1m },

                // ── Dairy ──
                new() { Name = "Whole Milk", Category = "Dairy", State = FoodState.Raw, CaloriesPer100g = 61, ProteinPer100g = 3.2m, CarbsPer100g = 4.8m, FatPer100g = 3.3m, FiberPer100g = 0m },
                new() { Name = "Skim Milk", Category = "Dairy", State = FoodState.Raw, CaloriesPer100g = 34, ProteinPer100g = 3.4m, CarbsPer100g = 5m, FatPer100g = 0.1m, FiberPer100g = 0m },
                new() { Name = "Mozzarella Cheese", Category = "Dairy", State = FoodState.Raw, CaloriesPer100g = 280, ProteinPer100g = 28m, CarbsPer100g = 3.1m, FatPer100g = 17m, FiberPer100g = 0m },
            };
